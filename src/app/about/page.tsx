      ...
      <main className="flex-1">
        <div className="mx-auto max-w-screen-xl px-4 flex flex-col ">
          ...
          <div className="flex flex-col lg:flex-row items-start ">
            ...
            {/* Left: Carousel */}
            <Carousel images={aboutImages} interval={3000} autoScroll
            ...
            <div className="flex flex-col justify-center gap-4 max-w-lg">
              ...
              <p className="text-base sm:text-lg">
                We are <span className="italic font-bold" style={{ color: teamColor }}>#9738 Ionic Bond</span>, a FIRST Robotics Competition team from Tel-Mond, Israel. Our
              ...
              <p className="sm:text-lg">
                ...
                <strong> alliance captain for the 4th alliance</strong> in Israeli District #4. We are also proud to have
                received the <strong>Rookie Inspiration Award</strong> (given to first-year teams that had a great impact
                on their community) twice and the <strong>Rookie High Seed Award</strong> (given to first-year teams that
              ...
              <p className="sm:text-lg">
                ...
                impact on our community and encourage a passion for <span className="relative group cursor-pointer font-bold">
                  STEAM
